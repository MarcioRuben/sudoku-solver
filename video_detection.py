...
templates_shapes = []
templates_grey = []
convert_templates = {} #gives each template an int value, the templates are the keys, and each one of them as a number as value
...
for i in range(0, 9):
    ...
    #adds a template and its respective
    convert_templates[f'images/template{i + 1}.png'] = i + 1 
...
convert_templates['images/whitespace1.png'] = 0
